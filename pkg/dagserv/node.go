...
// type assert to make sure we implement add method.
...
// TODO: I'm not sure if this is used in high level API or just used to store it on disk.
// TODO: maybe we should rewrite a new method to support read separated data from data.
